...
const Label = ({
  ...
  return (
    <div
      className={clsx('rounded-full px-3 py-1.5 shadow-[2px_1px_10px_1px_slate]', { // label box shadow
        'bg-gray-100 text-gray-900': color === 'default',
